            ...
            <div id="contenedor-productos">
                <div style="margin-left: 10px;">
                    ...
                    <div style="display: flex; justify-content: space-between;">
                        ...
                        <div><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ventana" id="botonOrdenar" onclick="modalCantidadOrdenar('${opcionMenu.precio}')">Ordenar</button></div>
                    </div>
                </div>
...
function modalCantidadOrdenar(precio){
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" onclick="agregarAlPedido(${parseInt(precio)})" style="background-color: #4F3EA3" id="ordenar">Ordenar</button>
                </div>
            </div>
        </div>
    </div>
...
function agregarAlPedido(precio){
    console.log(precio)
    $('#ventana').modal('hide');
}
